...
const alphabeticalOrder: string[] = [...visitedPlace];
...
const reverseAlphabetical: string[] = alphabeticalOrder.sort().reverse();
...
const originalReversed: string[] = visitedPlace.reverse();
...
const againReversed: string[] = originalReversed.reverse();
console.log("Reverse the order", againReversed);

// PART I
// • Sort your array so it’s stored in alphabetical order. Print the array to show that its order has been changed.

const sortInAlphabetical: string[] = againReversed.sort();
...
const againrevered: string[] = sortInAlphabetical.reverse();
